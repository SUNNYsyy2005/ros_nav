...
from breezyslam.sensors import Lidar1
...
def load_data(datadir, dataset):
    ...
    while True:  
        ...
        odometry = float(toks[1]), float(toks[2]), timestamp
                        
        lidar = [int(tok) for tok in toks[3:]]
...
class MinesLaser(Lidar1):
    
    def __init__(self):
        
        Lidar1.__init__(self, 70, 145)
