...
class Astar_DWA(object):
    ...
    def __init__(self, MAX_EDGE_LEN=5000, LIMIT_TRIAL=5000000):
        ...
        self.r = 5
        self.obstree = ()
        self.step_lenth = 0.5 #the steplenth of robot
        self.openlist = []
        self.closelist = []
        self.dwaPlanner = DWA()
        self.pathDebugger = Debugger()
        self.pathPointInterval = 10000 # A_star中取的路径点数量
    ...
    def plan(self, vision, start_x, start_y, start_angle, goal_x, goal_y, goal_angle):
        ...
        path = [[x, y] for x, y in zip(path_x, path_y)]
